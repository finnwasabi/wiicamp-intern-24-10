      ...
      <div className="grid gap-10 grid-cols-4 grid-rows-1">
        ...
        <div className="col-span-3 mt-10 relative">
          <div className="absolute flex bottom-[11px] left-1/2 -translate-x-1/2">
            <span className="h-3 w-3 mr-3 rounded-full bg-white opacity-30"></span>
            <span className="h-3 w-3 mr-3 rounded-full bg-white opacity-30"></span>
            <span className="h-3 w-3 mr-3 rounded-full bg-button-2 border-white border-2"></span>
            <span className="h-3 w-3 mr-3 rounded-full bg-white opacity-30"></span>
            <span className="h-3 w-3 rounded-full bg-white opacity-30"></span>
          </div>
          <Image
